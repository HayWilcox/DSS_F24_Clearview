...
class mirage_color:
    ...
    def select_mirage_color(self):
        self.cvcursor.execute('SELECT mirage_color_id, mirage_build_out, color_name, mirage_color, pivot_pro_color FROM mirage m INNER JOIN mirage_color mm ON m.mirage_id = mm.mirage_id INNER JOIN color c ON mm.color_id = me.color_id')
