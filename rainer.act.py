...
class rainier_act:
    ...
    def update_rainer_act(self, act_placement, act_housing, act_drive_side, act_hembar, act_pilebrush, act_brush_location, act_cord_length, act_mount_type, act_top_opening_width, act_top_level, act_bottom_opening_width, act_bottom_level, act_left_opening_height, act_left_plumb, act_right_opening_height, act_right_plumb, act_left_buildout, act_right_buildout, act_add_buildout, act_left_track, act_right_track, act_starting_point):
        self.cvcursor.execute('UPDATE rainier_act SET (WHERE act_placement FROM rainier = ) = act_housing = %s, act_drive_side = %s, act_hembar = %s, act_pilebrush = %s, act_brush_location = %s, act_cord_length = %s, act_mount_type = %s, act_top_opening_width = %s, act_top_level = %s, act_bottom_opening_width = %s, act_bottom_level = %s, act_left_opening_height = %s, act_left_plumb = %s, act_right_opening_height = %s, act_right_plumb = %s, act_left_buildout = %s, act_right_buildout = %s, act_add_buildout = %s, act_left_track = %s, act_right_track = %s, act_starting_point = %s', (act_placement, act_housing, act_drive_side, act_hembar, act_pilebrush, act_brush_location, act_cord_length, act_mount_type, act_top_opening_width, act_top_level, act_bottom_opening_width, act_bottom_level, act_left_opening_height, act_left_plumb, act_right_opening_height, act_right_plumb, act_left_buildout, act_right_buildout, act_add_buildout, act_left_track, act_right_track, act_starting_point))
        self.cvconn.commit()
